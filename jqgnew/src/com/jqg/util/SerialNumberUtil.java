...
public class SerialNumberUtil {
	 ...
	 * @return
	 */
	public static boolean verificationkey(String clientname,String address ,long validstart,long validend,String validday,String key,String key2,String key3){
		StringBuffer sb = new StringBuffer("");
		sb.append(MD5(clientname)).append("-");
		sb.append(MD5(address)).append("-");
		sb.append(MD5(validstart));
		sb.append(MD5(validend)).append("-");
		sb.append(MD5(validday));
		//比较加密后信息与key是否一致
		boolean iskey = false;
		if(sb.toString().equals(key)||sb.toString().equals(key2)||sb.toString().equals(key3)){
			iskey=true;
		}
