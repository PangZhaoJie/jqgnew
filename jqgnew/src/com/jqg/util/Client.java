...
public class Client
{
  ...
  public String UnRegister()
  {
    ...
    xml = xml + "<soap12:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap12=\"http://www.w3.org/2003/05/soap-envelope\">";
    xml = xml + "<soap12:Body>";
    xml = xml + "<UnRegister xmlns=\"http://tempuri.org/\">";
    xml = xml + "<sn>" + this.sn + "</sn>";
    xml = xml + "<pwd>" + this.password + "</pwd>";
    xml = xml + "</UnRegister>";
    xml = xml + "</soap12:Body>";
  ...
  public String UDPPwd(String newPwd)
  {
    ...
    xml = xml + "<soap12:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap12=\"http://www.w3.org/2003/05/soap-envelope\">";
    xml = xml + "<soap12:Body>";
    xml = xml + "<UDPPwd  xmlns=\"http://tempuri.org/\">";
    xml = xml + "<sn>" + this.sn + "</sn>";
    xml = xml + "<pwd>" + this.password + "</pwd>";
    xml = xml + "<newpwd>" + newPwd + "</newpwd>";
    xml = xml + "</UDPPwd>";
    xml = xml + "</soap12:Body>";
    xml = xml + "</soap12:Envelope>";
    try
    {
      ...
      {
        Pattern pattern = 
          Pattern.compile("<UDPPwdResult>(.*)</UDPPwdResult>");
        Matcher matcher = pattern.matcher(inputLine);
        while (matcher.find()) {
          result = matcher.group(1);
        }
  ...
  public String mdSmsSend_u(String mobile, String content, String ext, String stime, String rrid)
  {
    ...
    xml = xml + "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">";
    xml = xml + "<soap:Body>";
    xml = xml + "<mdSmsSend_u xmlns=\"http://tempuri.org/\">";
    xml = xml + "<sn>" + this.sn + "</sn>";
    xml = xml + "<pwd>" + this.pwd + "</pwd>";
    xml = xml + "<mobile>" + mobile + "</mobile>";
    xml = xml + "<content>" + content + "</content>";
