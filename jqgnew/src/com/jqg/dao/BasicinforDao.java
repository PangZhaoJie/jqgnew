...
public abstract interface BasicinforDao
{
  public abstract Integer addBasicinfor(Basicinfor paramBasicinfor)
    throws Exception;
  ...
  public abstract Basicinfor findBasicinforByPhone(String phone) throws Exception;
