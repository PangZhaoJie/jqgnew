...
public abstract interface ManagerDao {
	public abstract boolean addManager(Manager paramManager) throws Exception;
	...
	public abstract List<Manager> findManagers() throws Exception;
	...
	public abstract Manager findManagerByLogin(String paramString1,
	...
	public abstract List<Manager> findManagerspage1(int paramInt1,
			int paramInt2, Integer paramInteger) throws Exception;
	//查询客服信息
