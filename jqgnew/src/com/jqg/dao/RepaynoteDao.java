...
public abstract interface RepaynoteDao {
	...
	public abstract List<Repaynote> findRepaynotes() throws Exception;
	...
	public abstract List<Repaynote> findComRepay(String starttime,
