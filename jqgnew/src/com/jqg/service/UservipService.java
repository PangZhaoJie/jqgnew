...
public abstract interface UservipService {
	public abstract Integer createUservip(Uservip paramUservip)
			throws Exception;
	...
	public abstract Uservip findUservipByIdAndUserNameAndEmail(int id,
	...
	// 查询所有的下级用户
	public abstract List<Uservip> findUservips(int paramInt) throws Exception;
