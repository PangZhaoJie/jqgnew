...
<div class="s_banner"><img src="../images/tool_banner.jpg" /></div>
 <div class="conbox pt10">
    <P class="guide">当前位置：<a href="#">网站首页</a> > <a href="#">网贷工具</a> > 投资计算器</P>
    <div class="tool_ct pt10 mr_b10 fn_cle">
        <div class="conbox_l">
           <dl>
              <dt><i><img src="../images/tool_ico.png" /></i>网贷工具</dt>
              <dd><a href="borrow_tool.jsp">借款计算器</a></dd>
              <dd><a href="invest_tool.jsp">投资计算器</a></dd>
           </dl>
        </div>
        
        <div class="conbox_r">
         <h3><span>投资计算器</span></h3>
          <div class="conbox_r_nr">
              <P>目前支持网站正在使用的三种还款方式：按月分期还款、按月还息到期还本、到期还本息。</P>
              
              <div class="borrow_counter">
                 <div class="counter_title">投资设置</div>
                 <div class="b_counter_nr">
                    ...
                    <li><label>投资金额：</label><input name="name" id="money" type="text" size="25" value="100000"/><em>元</em></li>
                       
                      
                      
                         <li><label>投资期限：</label><input name="name" type="text" size="25" id="time"value="3" />
                       <em>     <input name="inptA" type="radio" id="inptA1" onclick="checkradio(this,1)"checked="checked"  value="0"/>月</em> 
                          <em>       <input name="inptA" type="radio" id="inptA2" onclick="checkradio(this,2);days();" value="1"/>日
                        
                        
                         </em>
                             
                         </li>
                           <li><label>投资奖励：</label><input name="name" id="away" type="text" size="25"value="0.6"/><em>%(无奖励填0)</em></li>
                       
                        <li style="width: 500px"><label>投资利率：</label><input name="name" type="text" size="25"  id="awayId" value="18"/><em>%
                ...
                <div  style="display: none;" id="resultnone">
                 ...
                 <div class="result">
                     <div class="return" >共返还本息<span id="total"></span></div> 
                     <div class="interest" >共获得利益<span id="rate"></span></div> 
                 </div>
                 </div>
                 <div style="display: none;" id="counter_title">
                <div class="counter_title">返还的时间表</div>
