...
function getJSONDatas(currentPage,pageSize,ziduan) {
	...
	$.getJSON(url,function(data){
		...
		document.getElementById("pages").style.display="";
         ...
         $ ("#tpagesnone").val(tp);
	     $ ("#firstPages").attr("href","javascript:getJSONDatas(1,10,'enable')");
	     $ ("#prevPages").attr("href","javascript:getJSONDatas("+(parseInt(cp)-1)+",10,'enable')");
	     $ ("#nextPages").attr("href","javascript:getJSONDatas("+(parseInt(cp)+1)+",10,'enable')");
	     $ ("#lastPages").attr("href","javascript:getJSONDatas("+(parseInt(tp))+",10,'enable')");
			}
			else{
