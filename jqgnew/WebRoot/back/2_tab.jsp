...
<body onload="tabTest(${mark})">
    ...
    <div class="rightinfo">
       ...
       <div id="hotnews_content">
    	...
    	<input  value="${lssuing.lssuingType}" name="lssuingType"  type="hidden"/>
          <ul class="m_forminfo">
            ...
            <li><label class="m_info_title">是否选择标种：</label>  
              <label><input type="radio" name="lssuing.recommend" value="1" id="RadioGroup1_0" <c:if test="${lssuing.recommend==1}">checked</c:if> />  新手标</label>
              <label><input type="radio" name="lssuing.recommend" value="7" id="RadioGroup1_2" <c:if test="${lssuing.recommend==7}">checked</c:if> />  医疗标</label>
           ...
           <!--  <li><label class="m_info_title">是否医疗标：</label>  
              <label><input type="radio" name="lssuing.recommend" value="7" id="RadioGroup1_0" <c:if test="${lssuing.recommend==7}">checked</c:if> />  是</label>
              <label><input type="radio" name="lssuing.recommend" value="0" id="RadioGroup1_1"  <c:if test="${lssuing.recommend==0}">checked</c:if>  /> 否</label>  
            </li> -->
        	...
        	<c:if test="${lssuing.lssuingType==7}">新手标</c:if>
			 </label></li>
          <!--  <li><label class="m_info_title">借款管理费：</label><input name="lssuing.manageMoney"   onkeyup="value=value.replace(/[^\d\.]/g,'')"  type="text" class="dfinput" id="manageMoneyId" value="${lssuing.manageMoney}" size="37"/><i>默认为按后台设置计算出来的，如果私下有协议可以改</i></li>  --> 
            ...
            <li><label class="m_info_title">是否通过：</label> 
                  ...
                  <c:if test="${lssuing.state==1 ||lssuing.state==2 }"><input type="radio" name="lssuing.state" value="3" id="RadioGroup3_0" /> 复审通过，还款中
            ...
            <c:if test="${lssuing.state==0 }">
             ...
             <c:if test="${lssuing.state==1 || lssuing.state==2 }">
