    	...
    	if(jQuery("#titleId").val()!=""&&
    	   ...
    	   jQuery("#copies").val()!="" ){
    		if(jQuery("#periodtimeId").val()!="0" || jQuery("#perioddayId").val()!="0"){
    			...
    			form.action="<%=path %>/borrow/saveLcLssuing?updateFlag=1&queryFlag="+queryFlag;
    			form.submit();
...
<!--             </li> -->
            ...
            <li>
            <label class="m_info_title">最低投资金额：</label>  
            <select name="lssuing.moneymin.moneyMinId" id="moneyMinId"  class="input">
            ...
            <li>
             <label class="m_info_title">最多投资金额：</label> 	                
	                   
		                <select name="lssuing.moneymax.moneyMaxId" id="moneymax"  class="input">
			              	 <option value=""  selected="selected">-请选择金额-</option>
			              	<c:forEach  var="moneymax" items="${moneymaxList}">
				              	<c:if test="${moneymax.moneyMaxId==1}">
				              		<option  value="${moneymax.moneyMaxId}">不限制</option>
				              	</c:if>
				              	<c:if test="${moneymax.moneyMaxId!=1}">	
...
<!--              <li><label class="m_info_title">借款管理费:</label><input name="lssuing.manageMoney"  type="text" class="dfinput" id="totalUnit1" value="" size="37"/><i>*</i></li> -->
           <li id="lineTop">
			 <label class="m_info_title">项目介绍：</label>
				<textarea name="lssuing.explains"  style="width:600px; height:100px; border:solid 1px #000000; border-radius:5px; resize:none;"></textarea>
			 </li>
