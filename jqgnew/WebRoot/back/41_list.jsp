...
<script type="text/javascript">
  function toMoneyPage(num){
	  ...
	  var mostMoney=$MP("#mostMoney").val();
   	  if(num==1){
			  ...
			  $MP("#page1-1").attr("href","<%=path %>/back/translate1.action?&page=1&mark="+mark+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney); 
	  }
	  if(num==3){
		  if(page<pageNum){
			  $MP("#page1-3").attr("href","<%=path %>/back/translate1.action?mark="+mark+"&page="+(Number(page)+1)+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney);
		  }else{
			  $MP("#page1-3").attr("href","<%=path %>/back/translate1.action?mark="+mark+"&page="+(Number(page))+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney);
		  }
	  }
	  if(num==2){
		  if(page>1){
			  $MP("#page1-2").attr("href","<%=path %>/back/translate1.action?mark="+mark+"&page="+(Number(page)-1)+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney);
		  }else{
			  $MP("#page1-2").attr("href","<%=path %>/back/translate1.action?mark="+mark+"&page="+(Number(page))+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney);
		  }
	  }
	  if(num==4){
		  ...
		  if(p<1){
			  ...
			  $MP("#page1-4").attr("href","<%=path %>/back/translate1.action?mark="+mark+"&page="+Number(p)+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney);
	  }
	  if(num==5){
   		  	
			  $MP("#page1-5").attr("href","<%=path %>/back/translate1.action?&page="+(Number(pageNum))+"&mark="+mark+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney); 
	  }
	  
  }
  function search(){
	  var form=document.getElementById("search");
	  form.action="<%=path %>/back/translate1.action?mark=0";
	  form.submit();
  }
  function kai(id){
  ...
  function commit(){
	  ...
	  form.action="<%=path %>/back/translate1.action?ok=1&texplain="+texplain+"&translateId="+hideId;
	  form.submit();
...
<!--         <li> <a href="#">将当前条件下数据导出为Excel</a></li> -->
    ...
    <table class="tablelist">
        ...
        <thead>
        	...
        	<td>
        	<fmt:formatNumber value="${translate.fee}" pattern="#0.00"/>
        	</td>
        	<td>
        	...
        	<c:if test="${sessionScope.powerss[40]==1}">
        	<td>
	            <a class="green" href = "javascript:void(0)" onclick="kai(${translate.translateId})">操作</a>
            </td>
            </c:if>
   ...
   <div id="hide" class="white_content" style="height: 280px;width: 480px">
	            ...
	            <div class="letter_info">
	                 <p style="font-weight:normal; font-size:14px;"> <input type="radio" name="state1" id="state1" value="1"/>审核通过
		              ...
		              <div class="tipbtn" style="margin-top:20px;margin-left:0;">
				        ...
				        <input type="button" value="确定" class="sure" onclick="commit()"/>
