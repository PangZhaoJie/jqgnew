...
<script type="text/javascript">
  function toMoneyPage(num){
	  ...
	  if(num==1){
		  ...
		  $MP("#page1-1").attr("href","<%=path %>/back/translate4.action?mark="+mark+"&page=1&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney); 
	  }
	  if(num==3){
		  if(page<pageNum){
			  $MP("#page1-3").attr("href","<%=path %>/back/translate4.action?mark="+mark+"&page="+(Number(page)+1)+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney);
		  }else{
			  $MP("#page1-3").attr("href","<%=path %>/back/translate4.action?mark="+mark+"&page="+(Number(page))+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney);
		  }
	  }
	  if(num==2){
		  if(page>1){
			  $MP("#page1-2").attr("href","<%=path %>/back/translate4.action?mark="+mark+"&page="+(Number(page)-1)+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney);
		  }else{
			  $MP("#page1-2").attr("href","<%=path %>/back/translate4.action?mark="+mark+"&page="+(Number(page))+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney);
		  }
	  }
	  if(num==4){
		  ...
		  if(p<1){
			  ...
			  $MP("#page1-4").attr("href","<%=path %>/back/translate4.action?mark="+mark+"&page="+Number(p)+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney);
	  }
	  if(num==5){
 		  	
		  $MP("#page1-5").attr("href","<%=path %>/back/translate4.action?mark="+mark+"&page="+Number(pageNum)+"&startTime="+startTime+"&endTime="+endTime+"&dealUser="+dealUser+"&userName="+userName+"&state="+state+"&lessMoney="+lessMoney+"&mostMoney="+mostMoney); 
	  }
	  
  }
  function search(){
      var form=document.getElementById("search");
	  form.action="<%=path %>/back/translate4.action?mark=0";
	  form.submit();
  }
</script>
