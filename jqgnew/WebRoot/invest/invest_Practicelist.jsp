...
<div class="maincontent">
  <div class="conbox pt20">
    <P class="guide">当前位置：<a href="<%=path%>/index.action">网站首页</a> > <a href="<%=path%>/tender/totenderList?lussingType=8">体验投资</a></P>
...
function getJSONData(currentPage,pageSize) {
	...
	var url = "tender/lssuinglistPage.action?currentPage="+currentPage+"&lussingType=8&pageSize="+pageSize+"&satate=" + 2+"&temp=" +Math.random();
...
function getJSONData1(currentPage,pageSize) {
	 document.getElementById("pageroots").style.display="none";
	var url = "tender/lssuinglistPage.action?currentPage="+currentPage+"&lussingType=8&pageSize="+pageSize+"&satate=" + 0+"&temp=" +Math.random();
	 jQuery.getJSON(url,function(data){
		var cp = data.currentPage;
		var tp = data.totalPage;
...
function getJSONData2(currentPage,pageSize) {
	 document.getElementById("pageroots").style.display="none";
	var url = "tender/lssuinglistPage.action?currentPage="+currentPage+"&lussingType=8&pageSize="+pageSize+"&satate=" + 3+"&temp=" +Math.random();
	 jQuery.getJSON(url,function(data){
		var cp = data.currentPage;
		var tp = data.totalPage;
...
function getJSONData3(currentPage,pageSize) {
	 document.getElementById("pageroots").style.display="none";
	var url = "tender/lssuinglistPage.action?currentPage="+currentPage+"&lussingType=8&pageSize="+pageSize+"&satate=" + 4+"&temp=" +Math.random();
	 jQuery.getJSON(url,function(data){
		var cp = data.currentPage;
		var tp = data.totalPage;
 ...
 function getJSONDatas(currentPage,pageSize) {
    ...
    if(parseInt(jQuery("#endmoney").val()) < parseInt(jQuery("#startMoney").val())){
	 ...
	 if(document.getElementById("dayCheckId").checked){
			url = "tender/findlssuingBytender.action?currentPage="+currentPage+"&&lussingType=8pageSize="+pageSize+"&returnWayId="+ jQuery("#time0").val()+"&moneyUseId="+ jQuery("#yongtu").val()+"&periodTimeId="
			...
			url = "tender/findlssuingBytender.action?currentPage="+currentPage+"&lussingType=8&pageSize="+pageSize+"&returnWayId="+ jQuery("#time0").val()+"&moneyUseId="+ jQuery("#yongtu").val()+"&periodTimeId="
