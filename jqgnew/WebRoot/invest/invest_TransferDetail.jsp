...
<div class="maincontent">
    ...
    <div class="tend_r">
      <div class="tend_form">
       <form action="<%=path%>/transfer/transferBuy" method="post" name="tender" onsubmit="getElementById('invest_bt').disabled=true;return true;">
       <input type="text"  style="display: none;" value="${sessionScope.lssuing.lssuingId}"  id="lssuingId" name="lssuingId"></input>
			   <div id="moneyState"><label class="title">债权持有人</label><span>${username}</span></div>
            ...
            <s:else>
            <div id="textState">
               <label class="title">收益金额</label> <input type="text"  value="${benxistr}" size="24" name="money" id="tip" readonly="readonly" style="border: none;"></input> </br> </br>
               <label class="title">认购价格</label> <input type="text"  value="${transferMoney}" size="24" name="money" id="tip" readonly="readonly" style="border: none;"></input> </br> </br>
             ...
             <div class="invest_btn"  >
                   ...
                   <c:if test="${transfer!=3}">
                   	<input type="submit" class="invest_bt" id="invest_bt" value="立即认购" />
                   </c:if>
                   <c:if test="${transfer==3}">
                   	<input type="button" class="invest_bt" id="" value="已认购完" />
                   </c:if>
             </div>
             </form>  
             </div>
