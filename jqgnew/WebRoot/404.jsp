...
<body>
	...
	<div class="w960">
		...
		<div class="main">
			<h1>很抱歉，此页面暂时不可用或者太忙。请稍后重试…</h1>
			<div class="goout">
				<a href="javascript:history.back(-1)" title="重试">重 试</a> <a href="<%=path %>"
					title="返回首页">返回首页</a>
			</div>
			<p class="erro">
				-->请检查您输入的网址是否正确。<br /> -->如果您不能确认网址是否正确，请点击<a href="<%=path %>" title="返回首页">返回首页</a>浏览其他页面。<br />
